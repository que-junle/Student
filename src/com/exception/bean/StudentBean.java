...
public class StudentBean {
	...
	public StudentBean(String f_name, int f_sex, String f_photo, String f_phone, Date f_time, RoomBean roomBean,
			ClassBean classBean) {
		super();
		this.f_name = f_name;
		this.f_sex = f_sex;
	...
	public StudentBean(int pk_id, String f_name, int f_sex, String f_photo, String f_phone, Date f_time,
			RoomBean roomBean, ClassBean classBean) {
		super();
		this.pk_id = pk_id;
		this.f_name = f_name;
		this.f_sex = f_sex;
